    ...
    <>
      ...
      >
        ...
        >
          <path
            ...
            className="stroke-black transition duration-200 group-hover:stroke-[#9A9A9F]"
          />
        </svg>
        <span className="transition duration-200 group-hover:text-gray">
          Return to all blogs
        </span>
      </Link>
      ...
      <div className="border-1 relative flex !h-[441px] !max-h-[441px] w-[100%] items-center justify-center border border-borderColor sm:h-[auto] sm:items-start md:h-[346px] md:w-[100%]">
        ...
        {blog?.categories?.length ? (
          <div className="font-13px-ALL absolute bottom-0 left-[50%] flex translate-x-[-50%] translate-y-[50%] items-center justify-center rounded-[5px] bg-[#9A9A9F] !px-[16px] !py-[8px] text-center text-gray4 sm:w-[max-content] sm:max-w-[100%] sm:text-[13px] sm:leading-[16px]">
        ...
        <div className="!mb-[32px] !mt-[32px] flex items-center justify-between sm:!mb-[40px] sm:!mt-[40px]">
          <div className="w-[100%] max-w-[416px]">
            {prevBlog && (
              <Link href={`/${prevBlog.slug}`}>
                <div className="flex items-center gap-x-[16px] [&_button]:transition [&_button]:duration-300 [&_button]:hover:!border-[#9A9A9F] [&_button]:hover:!bg-[#f0f0f0] dark:[&_button]:hover:!bg-transparent [&_div]:hover:!text-darkgray [&_path]:hover:stroke-[#9A9A9F] [&div]:duration-300 [&path]:transition [&path]:duration-300">
                  <button
          ...
          <Link href={"/blog"}>
            <svg
              ...
              height="32"
              fill="none"
              className="[&_rect]:transition [&_rect]:duration-300 [&_rect]:hover:stroke-[#9A9A9F]"
            >
              <rect
                width="8.5"
                height="8.5"
          ...
          <div className="w-[100%] max-w-[416px]">
            {nextBlog && (
              <Link href={`/${nextBlog.slug}`}>
                <div className="flex items-center justify-end gap-x-[16px] transition duration-300 [&_button]:transition [&_button]:duration-300 [&_button]:hover:!border-[#9A9A9F] [&_button]:hover:!bg-[#f0f0f0] dark:[&_button]:hover:!bg-transparent [&_div]:hover:!text-darkgray [&_path]:hover:stroke-[#9A9A9F]  [&div]:transition [&div]:duration-300 [&path]:transition [&path]:duration-300">
                  <div className="sm:hidden">
      ...
      {/* {relatedBlogs.length ? (
            <div className="mt-[92px] flex w-[100%] max-w-[896px] flex-col items-center justify-center overflow-hidden sm:mt-[80px] md:mt-[72px]">
              ...
              <div className="mt-[16px] h-[2px] w-[48px] rounded-[2px] bg-[#9A9A9F]"></div>
