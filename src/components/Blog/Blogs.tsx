  ...
  return (
    <>
      <div className="container-margin-bottom-D96px-M64px mt-[48px] w-[100%] ">
          ...
          <div className="flex w-[896px] flex-col md:w-[100%]">
            ...
            >
              <div
                className={classNames({
                  "cursor-pointer": true,
                  "[&_path]:stroke-[#333333]": blogViewMode == "image",
                  "[&_path]:stroke-gray2 [&_path]:hover:stroke-[#333333]":
                    blogViewMode == "text",
                })}
              ...
              <div
                className={classNames({
                  ...
                  "text-gray2 hover:text-[#333333]": blogViewMode == "image",
                  "text-[#333333]": blogViewMode == "text",
                })}
        ...
        <div
          className="fixed left-0 top-[356px] z-[1] hidden items-center justify-center rounded-r-[5px] bg-[#333333] opacity-70 sm:flex sm:h-[44px] sm:w-[44px] md:flex md:h-[44px] md:w-[44px]"
