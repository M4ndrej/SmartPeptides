  ...
  return (
    <>
      <div className="container-margin-bottom-D96px-M64px mt-[48px] w-[100%] ">
        ...
        <div
          className="fixed left-0 top-[356px] z-[1] hidden items-center justify-center rounded-r-[5px] bg-[#9A9A9F] opacity-70 sm:flex sm:h-[44px] sm:w-[44px] md:flex md:h-[44px] md:w-[44px]"
