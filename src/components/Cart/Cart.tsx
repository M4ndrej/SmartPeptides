              ...
              <div className="mb-[8px] flex h-full w-full flex-1 flex-col justify-between gap-[16px] px-[32px] pt-[32px] sm:px-[10px] sm:pt-0 from834:px-[24px] ">
                ...
                <div>
                    ...
                    <div
                      ...
                      className={classNames({
                        "font-D16px-M14px flex w-[50%] cursor-pointer select-none items-center justify-center rounded-l-[5px] text-center font-normal text-gray2 transition duration-200 hover:text-darkgray dark:text-borderGray":
                          true,
                        "!font-bold dark:!text-[#E7461E]": cartType === "US",
                      })}
                    >
                      US
                    </div>
                  ...
                  <div className="relative mt-[8px] h-[2px] w-full overflow-hidden rounded-[5px] bg-borderGray">
                    <div
                      className={classNames({
                        "absolute left-0 h-[2px] w-[50%] bg-gray2 transition-all duration-[300ms] ease-in-out dark:bg-[#E7461E]":
                          true,
                      ...
                      <div className="flex justify-between">
                        <div className="flex flex-wrap gap-1">
                          ...
                          <Link
                            ...
                            className={classNames(
                              "group/gift flex gap-1 font-bold uppercase text-[#E7461E] transition-colors duration-200 hover:text-[#E7461E]",
                              hasGift && "pointer-events-none"
                            )}
                          >
                            <GiftIcon className="fill-[#E7461E] stroke-[#E7461E] transition-colors duration-200 group-hover/gift:fill-[#E7461E] group-hover/gift:stroke-[#E7461E]" />
                            <span>FREE GIFT</span>
                          </Link>
                        </div>
                        {hasGift && (
