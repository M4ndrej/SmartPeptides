      ...
      icon: (
        <SystemIcon
          ...
          className={classNames(
            "group-hover/selectMode:fill-[#E7461E} group-hover/toggleBtn:fill-[#E7461E}"
          )}
          width={32}
          height={32}
        />
      ...
      >
        <span>
          {state.themeMode === "dark" ? (
            <MoonIcon
              className={classNames(
                "group-hover/toggleBtn:!fill-[#E7461E} !fill-black transition duration-200"
              )}
        ...
        <DropdownIcon
          className={classNames(
            "group-hover/toggleBtn:!stroke-[#E7461E} hidden transition duration-200 xl:block",
        ...
        {options.map((option) => (
          <li key={option.value}>
            <button
              ...
              className={classNames(
                "font-14px-ALL group/selectMode hover:fill-[#E7461E} flex items-center gap-[8px] text-gray2 transition duration-200 hover:text-[#E7461E] focus:outline-none",
                { "!text-[#E7461E}": option.value === state.themeMode }
              )}
