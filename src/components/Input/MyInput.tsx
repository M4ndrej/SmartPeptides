      ...
      <div className={classNames("relative", inputContainerClassName)}>
        ...
        <input
          ...
          className={classNames(
            ...
            isFocused && !reverseColors && "!bg-[#FFE9E3] dark:!bg-transparent",
            isFocused && reverseColors && "!bg-inputColor ",
            value &&
              !isFocused &&
              !reverseColors &&
              !disabled &&
              "!border-light-blue2 !bg-[#FFE9E3] !text-[#E7461E] dark:!bg-transparent",
            value &&
              !isFocused &&
              reverseColors &&
              !disabled &&
              "!border-white !bg-white !text-[#E7461E] dark:!border-none",
            isError && "!border-red !bg-lightred !text-red",
            disabled &&
              "!border-lightgray !bg-lightgray text-gray2 dark:text-[#E7461E]",
            className
          )}
          {...restProps}
        />
        {type === "password" && !icon && (
          <div className="absolute right-4 top-[50%] translate-y-[-50%] cursor-pointer">
            <EyeIcon
              ...
              className="transition-colors duration-200 hover:!stroke-[#E7461E]"
              onClick={() =>
