        ...
        <input
          ...
          className={classNames(
            ...
            value &&
              ...
              !reverseColors &&
              !disabled &&
              "!border-light-blue2 !bg-[#f0f0f0] !text-darkgray dark:!bg-transparent",
            value &&
              !isFocused &&
              reverseColors &&
              !disabled &&
              "!border-white !bg-white !text-darkgray dark:!border-none",
            isError && "!border-red !bg-lightred !text-red",
            disabled &&
              "!border-lightgray !bg-lightgray text-gray2 dark:text-darkgray",
            className
          )}
          {...restProps}
        />
        {type === "password" && !icon && (
          <div className="absolute right-4 top-[50%] translate-y-[-50%] cursor-pointer">
            <EyeIcon
              ...
              className="transition-colors duration-200 hover:!stroke-[#9A9A9F]"
              onClick={() =>
