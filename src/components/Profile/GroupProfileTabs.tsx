        ...
        {items.map((item) => (
          <div
            ...
            className={classNames(
              "font-D16px-M13px  cursor-pointer rounded-[5px] p-[16px] transition-all ease-in-out hover:bg-lightgray hover:font-bold hover:text-[#E7461E] sm:py-[10px]",
              item.id == selectedId && "bg-lightgray font-bold text-[#E7461E]",
              item.id == selectedId &&
