    ...
    <div className="relative">
      ...
      >
        ...
        <div className="sm:max-h-auto mb-[32px] sm:h-auto">
          <Link href={`/${blog.slug}`}>
            <h2
              className="font-D18px-M16px transtion mb-[8px] line-clamp-1 cursor-pointer font-bold duration-300 hover:text-gray"
      ...
      <div>
        <Link
          href={`/${blog.slug}`}
          className="font-D16px-M14px absolute bottom-0 cursor-pointer font-medium text-darkgray transition duration-300 hover:text-gray "
        >
          READ MORE +
        </Link>
      </div>
