              ...
              section !== "search" && (
                ...
                >
                  ...
                  <div className="mt-[24px] flex items-center gap-[24px] md:gap-[16px]">
                    ...
                    >
                      {" "}
                      <QuickviewIcon customClass="w-[32px] h-[32px] [&_path]:stroke-gray2 [&_circle]:stroke-gray2 [&_path]:group-hover/quickView:stroke-[#9A9A9F] [&_circle]:group-hover/quickView:stroke-[#9A9A9F]" />{" "}
                      QUICK VIEW
                    </div>
                    {/* Wishlist btn */}
                    <WishlistButton
