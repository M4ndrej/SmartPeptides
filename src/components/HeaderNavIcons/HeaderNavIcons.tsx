    ...
    >
      ...
      >
        ...
        {wishlistItemIds.length > 0 && (
          <div
            className={classNames({
              "font-D13px-M11px absolute right-[-5px] top-0 flex h-[20px] w-[20px] select-none items-center justify-center rounded-full bg-[#E7461E] text-white sm:right-[-3px] sm:top-[-3px] sm:h-[18px] sm:w-[18px] sm:pt-[1px]":
                true,
