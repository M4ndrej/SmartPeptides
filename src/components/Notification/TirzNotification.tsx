  ...
  return (
    <SuspendRender isRendered={isRendered}>
      {(isVisible) => (
        ...
        >
          <div className="flex h-full min-h-[168px] w-full items-center justify-between gap-6 rounded-[5px] border-[2px] border-[#9A9A9F] bg-white p-8 sm:flex-col sm:gap-4 lg:gap-16">
            ...
            <div className="flex w-auto shrink-0 grow items-center justify-between gap-6 sm:w-full lg:gap-16">
              <div className="flex items-center justify-start gap-2">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sm text-darkgray xs:text-xs md:text-base">
                    <span>
          ...
          >
            <XMarkIcon
              width={24}
              height={24}
              className="!stroke-gray2 transition-colors duration-300 group-hover/closeBtn:!stroke-[#9A9A9F]"
            />
          </button>
        </div>
      )}
