            ...
            <div key={i} className={col.style}>
              ...
              {col.id == "5" && (
                ...
                >
                  ...
                  <div>
                    <div
                      className={`flex cursor-pointer  select-none items-center [&_div]:transition [&_div]:duration-200 [&_div]:hover:text-gray [&_path]:transition [&_path]:duration-200 [&_path]:hover:stroke-[#9A9A9F]`}
                      onClick={() => viewOrder()}
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="flex flex-1 justify-between sm:flex-col sm:text-[14px]">
                      <div className="sm:mb-[4px]">
                        <div
                          className="font-D16px-M13px mb-[4px] cursor-pointer font-bold transition duration-200 hover:text-gray"
                          onClick={() =>
