    ...
    >
      ...
      <div className="flex items-center gap-[10px]">
        ...
        {showSpinner ? (
          ...
          <>
            <div
              className="group flex h-[41px] w-[41px] cursor-pointer select-none items-center justify-center rounded-[7px] bg-[#f0f0f0] transition duration-300 hover:bg-[#9A9A9F] dark:bg-transparent"
