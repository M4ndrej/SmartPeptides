    ...
    >
      ...
      <div className="flex items-center gap-[10px]">
        ...
        {showSpinner ? (
          ...
          <>
            <div
              className="group flex h-[41px] w-[41px] cursor-pointer select-none items-center justify-center rounded-[7px] bg-[#FFE9E3] transition duration-300 hover:bg-[#E7461E] dark:bg-transparent"
