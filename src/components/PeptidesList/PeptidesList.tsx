    ...
    <>
      <div
        ...
        className={classNames({
          "absolute left-0 flex h-[44px] w-[44px] cursor-pointer select-none items-center justify-center rounded-r-[5px] bg-[#9A9A9F] opacity-70 duration-200 hover:bg-[#9A9A9F] sm:top-[-70px] md:top-[25px] ":
            true,
