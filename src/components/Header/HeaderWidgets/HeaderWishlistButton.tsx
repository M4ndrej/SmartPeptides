  ...
  return (
    ...
    >
      {!!wishlistItemIds.length && (
        <div
          className={classNames(
            "font-D13px-M11px absolute right-[-5px] top-0 flex h-[20px] w-[20px] cursor-pointer select-none items-center justify-center rounded-full bg-[#9A9A9F] text-white sm:right-[-3px] sm:top-[-3px] sm:h-[14px] sm:w-[14px] sm:pt-[1px]",
      ...
      <HeartIcon
        className={classNames(
          "transition-colors duration-300 group-hover/wishlist:!fill-[#9A9A9F]",
