  ...
  return (
    <div className="flex items-center justify-end gap-1 overflow-visible">
      ...
      >
        {!!itemCount && (
          <div
            className={classNames(
              "font-D13px-M11px absolute right-[-5px] top-0 flex h-[20px] w-[20px] cursor-pointer select-none items-center justify-center rounded-full bg-[#E7461E] text-textWhite sm:right-[-3px] sm:top-[-3px] sm:h-[14px] sm:w-[14px] sm:pt-[1px]",
              itemCount > 9 &&
        ...
        <BagIcon className="transition-colors duration-300 group-hover/cart:!fill-[#E7461E] sm:!h-6 sm:!w-6" />
      </button>
    </div>
  );
};
