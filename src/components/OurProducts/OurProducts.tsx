        ...
        {productFilter.map((item: any, index: number) => (
          <div
            ...
            className={classNames({
              "product-filter-btn font-D16px-M14px animate-font-weight underlineNew relative cursor-pointer transition-[color] ease-in-out  hover:text-[#E7461E] sm:mt-[32px] sm:flex sm:flex-row-reverse sm:items-center [&_div]:hover:w-[100%]":
                true,
              "text-darkgray": currentFilter !== item.name,
              "!font-bold !text-[#E7461E] after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full after:bg-[#E7461E] after:content-['']":
          ...
          >
            ...
            {/* <div
              className={classNames({
                "h-[2px] w-0 rounded bg-[#E7461E] transition-[width] ease-in-out sm:mr-[16px] sm:w-[24px]":
                  true,
