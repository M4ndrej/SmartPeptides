    ...
    <div className=" ">
      ...
      >
        <div className="col-span-2 flex items-center gap-[16px] lg:col-span-3">
          ...
          >
            <svg
              ...
              className={classNames({
                ...
                "[&_path]:hover:fill-[#9A9A9F]": !isInDeleteProcess,
              })}
            >
              <path
                fillRule="evenodd"
          ...
          <Link
            href={`/${itemURL}`}
            className="font-D16px-M12px overflow-hidden text-ellipsis whitespace-nowrap transition duration-200 hover:text-gray md:max-w-none"
          >
            {item.title}{" "}
          </Link>
        </div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className=" font-D16px-M13px text-darkgray md:min-w-[80px]">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p
            className={classNames({
              "font-D16px-M13px min-w-[98px] text-center text-darkgray md:min-w-[80px]":
                true,
            })}
          >
