          ...
          {blogs?.map((blog, i) => (
            <Link key={i} href={`/${blog.slug}`} className="group">
              <div className="flex cursor-pointer gap-x-[8px]">
                ...
                <div
                  className="font-16px-ALL !text-gray2 transition duration-300 group-hover:!text-darkgray"
      ...
      <div>
        ...
        <div className="flex flex-col gap-y-[16px]">
          <div onClick={() => changeCategory(0)}>
            <div className="flex cursor-pointer items-center gap-x-[8px] [&_div]:hover:text-gray">
              <div
                className={classNames({
                  " h-[8px] w-[8px] min-w-[8px] rounded-full": true,
                  "bg-gray": activeCategory != 0,
                  "bg-[#9A9A9F]": activeCategory == 0,
                })}
              ></div>
              <div
                className={classNames({
                  ...
                  "font-bold text-darkgray": activeCategory == 0,
                })}
              >
                All categories
              </div>
              ...
              <div className="flex cursor-pointer items-center gap-x-[8px] [&_div]:hover:text-gray">
                <div
                  className={classNames({
                    ...
                    "bg-[#9A9A9F]": activeCategory == category.id,
                  })}
                ></div>
                <div
                  className={classNames({
                    ...
                    "font-bold text-darkgray": activeCategory == category.id,
                  })}
                >
                  {category.name}
                </div>
