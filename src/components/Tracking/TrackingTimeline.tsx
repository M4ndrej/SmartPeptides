            ...
            .map((s, i) => (
              <div
                ...
                className={classNames(
                  ...
                  i < activeIndex ? "bg-[#9A9A9F]" : "bg-gray4"
                )}
              />
            ))}
        </div>
        <div className="absolute inset-0 flex h-5 items-center justify-between sm:h-full sm:w-5 sm:flex-col">
          {trackingStatuses.map((s, i) =>
            i <= activeIndex ? (
              <div
                key={s.key}
                className="flex h-5 w-5 items-center justify-center rounded-full bg-[#9A9A9F]"
              >
        ...
        {trackingStatuses.map((s, i) => (
          <div
            ...
            className={classNames(
              ...
              i <= activeIndex ? "font-bold text-darkgray" : "text-gray2",
