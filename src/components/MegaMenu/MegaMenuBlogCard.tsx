    ...
    <div className="flex gap-[16px]">
      ...
      <div className="flex flex-col justify-between">
        <div>
          <Link
            href={`/${blog.slug}`}
            className="font-18px-ALL mb-[8px] line-clamp-1 cursor-pointer font-bold transition duration-200 hover:text-gray"
        ...
        <Link
          href={`/${blog.slug}`}
          className="font-16px-ALL group flex items-center gap-[8px] font-medium text-darkgray transition duration-200 hover:text-gray"
        >
          READ MORE
          <svg
            width="12"
