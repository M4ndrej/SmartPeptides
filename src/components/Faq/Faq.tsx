            ...
            {FAQS_DATA.map((item, index) => (
              ...
              >
                <div
                  ...
                  className={classNames({
                    "flex w-[592px] cursor-pointer items-center rounded-[5px] border-[1px] border-solid border-borderColor px-[14px] py-[12px] transition duration-300 ease-linear hover:border-[#9A9A9F] hover:bg-[#f0f0f0] sm:w-[100%] sm:px-[16px] sm:py-[13px] md:w-[100%] dark:hover:border-borderColor dark:hover:bg-transparent":
                      true,
                    "!border-[#9A9A9F] bg-[#f0f0f0] dark:!border-borderColor dark:bg-transparent":
