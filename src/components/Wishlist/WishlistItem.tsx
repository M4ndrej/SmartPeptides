      ...
      >
        <div className="flex flex-1">
          ...
          <div className="flex flex-col justify-center gap-[8px]">
            ...
            <div
              className="font-D16px-M13px cursor-pointer select-none text-gray2 transition duration-300 hover:text-gray"
              onClick={() => {
        ...
        <div
          className={`group h-[16px] w-[16px] select-none ${
            wishlistItemLoading
              ? "cursor-wait"
              : "cursor-pointer [&_circle]:transition [&_circle]:duration-300 [&_circle]:hover:fill-[#9A9A9F]"
          }`}
          onClick={() =>
        ...
        >
          ...
          >
            <path
              ...
              fill="#999999"
              className="transition duration-200 group-hover:fill-[#9A9A9F]"
            />
          </svg>
        </div>
      </div>
