          ...
          <div className="flex flex-wrap gap-[16px] sm:justify-center">
            ...
            {items?.otherVolumes?.length && (
              <div
                className={classNames({
                  "font-D16px-M14px flex h-[38px] cursor-pointer select-none items-center rounded-[2px] border border-gray bg-lightgray px-[16px] py-[6px] text-gray2 transition duration-300 hover:border-[#E7461E] hover:bg-white hover:text-[#E7461E] sm:max-h-[30px] sm:px-[14px] sm:py-[4px]":
                    true,
                  "!border-[#E7461E] !bg-[#E7461E] !text-white":
            ...
            {otherVolumesSelected && (
              <Input
                ...
                customClass=" appearance:textfield font-16px-ALL remove-number-input-arrows !h-[38px] rounded-[2px] border border-[#E7461E] px-[16px] py-[7px] sm:px-[14px] sm:py-[4px] sm:max-h-[31px] text-gray2 outline-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
              />
            )}
          </div>
        </div>
