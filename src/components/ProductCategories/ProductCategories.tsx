    ...
    <>
      ...
      <div className="px-[10px]" ref={elRef}>
        <div
          ...
          className={classNames({
            "font-14px-ALL relative z-[2] mt-[8px] hidden w-full items-center justify-between rounded-[5px] bg-[#FFE9E3] px-[16px] py-[8px] font-bold text-[#E7461E] sm:flex dark:bg-transparent":
              true,
