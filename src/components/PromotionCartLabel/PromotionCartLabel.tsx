...
const PromotionCartLabel: FC<PromotionCartLabelProps> = ({
  ...
  return (
    <div className="font-D15px-M10px flex w-full items-center justify-center gap-[8px] border-[1px] border-dashed border-[#333333] px-[5px] py-[10px]  sm:py-[9px]">
      <div className="flex items-center justify-center gap-[8px]">
        <div className="flex flex-wrap items-center gap-[4px]">
          <p className="m-0 flex items-center justify-between gap-[8px]">
            <span className="block h-[8px] w-[8px] rounded-[8px] bg-[#333333]"></span>{" "}
            {textNormal}
          </p>
