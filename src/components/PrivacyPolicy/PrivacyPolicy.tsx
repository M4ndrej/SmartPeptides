    ...
    <>
      <div className="container-padding-inline m-[auto] mt-[48px] w-[100%] max-w-[1264px] sm:max-w-[100vw] md:max-w-[100vw]">
        ...
        <div className="font-D16px-M13px">
          ...
          <div className="mb-[20px]">
            You also agree not to upload or share content that is illegal,
            offensive, harmful, defamatory, invasive of privacy, or otherwise
            inappropriate.
          </div>
        </div>
        ...
        <div className="font-16px-ALL container-margin-bottom-D96px-M64px">
          ...
          <div className="mb-[20px]">
            ...
            traffic, and gather demographic insights. This data is not connected
          ...
          <div className="mb-[20px]">
            ...
            during checkout may also be used for shipping notifications or
            promotional SMS messages if you choose to opt in. Standard messaging
            fees may apply.
          </div>
          ...
          <div className="mb-[20px]">
            You may unsubscribe from promotional emails at any time by clicking
            the Unsubscribe link included in each message. For text messages,
            you can opt out by replying STOP. Please allow up to ten business
