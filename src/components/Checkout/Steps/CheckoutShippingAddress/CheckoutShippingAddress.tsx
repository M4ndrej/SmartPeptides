          ...
          <form action={handleChangeUserAddressAction}>
            ...
            <div className="flex w-full flex-col gap-[32px]">
              ...
              <div className="flex flex-col-reverse items-center justify-between gap-[16px] lg:flex-row">
                <Link
                  href="/cart"
                  className="font-D16px-M14px group/link flex items-center justify-start gap-[16px] uppercase transition duration-200 ease-linear hover:text-gray lg:w-full"
                >
                  <svg
                    width="7"
                    height="13"
