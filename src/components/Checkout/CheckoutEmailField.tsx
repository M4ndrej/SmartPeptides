          ...
          <>
            ...
            <div className="flex w-full justify-end gap-4 sm:flex-col">
              ...
              <Button
                ...
                customClass="!border-none !p-0 !bg-transparent hover:!text-[#E7461E]"
              />
            </div>
        ...
        {state == "existing-login" && (
          <>
            ...
            <div className="mt-3 flex justify-end gap-4">
              ...
              <div
                className="font-D14px-M13px cursor-pointer transition duration-300 hover:text-[#E7461E] sm:leading-4"
                onClick={() => {
